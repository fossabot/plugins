import{_ as e,X as i,Y as t,a1 as n,a2 as s,Z as l,a0 as p,C as r}from"./framework-ea1ea870.js";const o={},u=n("h1",{id:"一主多子项目配置",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#一主多子项目配置","aria-hidden":"true"},"#"),s(" 一主多子项目配置")],-1),c={href:"https://github.com/ihub-pub/multi-template",target:"_blank",rel:"noopener noreferrer"},d=p(`<h2 id="配置-wrapper" tabindex="-1"><a class="header-anchor" href="#配置-wrapper" aria-hidden="true">#</a> 配置 wrapper</h2><div class="language-properties line-numbers-mode" data-ext="properties"><pre class="language-properties"><code><span class="token key attr-name">distributionUrl</span><span class="token punctuation">=</span><span class="token value attr-value">https\\://services.gradle.org/distributions/gradle-8.1.1-bin.zip</span>
    ...
    id <span class="token string">&#39;pub.ihub.plugin.ihub-settings&#39;</span> version <span class="token string">&#39;1.3.2&#39;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,11);function b(v,g){const a=r("ExternalLinkIcon");return i(),t("div",null,[u,n("p",null,[s("一个主多子项目配置，参见"),n("a",c,[s("项目模板"),l(a)])]),d])}const m=e(o,[["render",b],["__file","multiAdvanced.html.vue"]]);export{m as default};
