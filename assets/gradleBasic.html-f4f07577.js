import{_ as i,X as t,Y as l,a1 as n,a2 as a,Z as e,a0 as r,C as o}from"./framework-ea1ea870.js";const p={},c=n("h1",{id:"gradle基础入门",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#gradle基础入门","aria-hidden":"true"},"#"),a(" Gradle基础入门")],-1),d=n("code",null,"Gradle",-1),u={href:"https://ant.apache.org/",target:"_blank",rel:"noopener noreferrer"},v={href:"https://maven.apache.org/",target:"_blank",rel:"noopener noreferrer"},m={href:"https://groovy.apache.org/",target:"_blank",rel:"noopener noreferrer"},g={href:"https://gradle.org/maven-vs-gradle/",target:"_blank",rel:"noopener noreferrer"},b=n("img",{src:"https://gradle.org/images/gradle-vs-maven.gif",alt:"Gradle vs Maven",tabindex:"0",loading:"lazy"},null,-1),k=n("figcaption",null,"Gradle vs Maven",-1),h=r(`<h2 id="配置-wrapper" tabindex="-1"><a class="header-anchor" href="#配置-wrapper" aria-hidden="true">#</a> 配置 wrapper</h2><blockquote><p>推荐使用<code>wrapper</code>的方式配置 Gradle 环境，便于保持项目环境统一，在项目根目录下添加<code>gradle/wrapper/gradle-wrapper.properties</code>配置文件，详细配置见入门文档，配置内容如下：</p></blockquote><div class="language-properties line-numbers-mode" data-ext="properties"><pre class="language-properties"><code><span class="token key attr-name">distributionUrl</span><span class="token punctuation">=</span><span class="token value attr-value">https\\://services.gradle.org/distributions/gradle-8.1.1-bin.zip</span>
...
├── gradlew
└── gradlew.bat
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,20);function f(w,_){const s=o("ExternalLinkIcon");return t(),l("div",null,[c,n("blockquote",null,[n("p",null,[d,a("是源于 "),n("a",u,[a("Apache Ant"),e(s)]),a(" 和 "),n("a",v,[a("Apache Maven"),e(s)]),a(" 概念的项目自动化构建开源工具，它使用一种基于 "),n("a",m,[a("Groovy"),e(s)]),a(" 的特定领域语言 (DSL) 来声明项目设置，抛弃了基于 XML 的各种繁琐配置面向 Java 应用为主。当前其支持的语言暂时有 Java、Groovy、Kotlin、Scala、Android、C++ 和 Swift。 下面是 Gradle 和 Apache Maven 的一个比较：")])]),n("figure",null,[n("a",g,[b,e(s)]),k]),h])}const y=i(p,[["render",f],["__file","gradleBasic.html.vue"]]);export{y as default};
